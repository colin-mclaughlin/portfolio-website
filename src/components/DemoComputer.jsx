...
const DemoComputer = (props) => {
    ...
    const txt = useVideoTexture(props.texture ? props.texture : '/textures/project/project1.mp4') // Can screen record and upload own mp4 video to use here to show own projects
